...
$cbc = $xml->createElement('cbc:ID', $factura[0]->Ser_Doc.'-'.$factura[0]->Num_Doc);
$cbc = $Invoice->appendChild($cbc);

$cbc = $xml->createElement('cbc:IssueDate', $factura[0]->Fec_Doc);
$cbc = $Invoice->appendChild($cbc);

$cbc = $xml->createElement('cbc:InvoiceTypeCode', $factura[0]->Cod_Doc);
$cbc = $Invoice->appendChild($cbc);

$cbc = $xml->createElement('cbc:DocumentCurrencyCode', $factura[0]->Cod_Alf);
$cbc = $Invoice->appendChild($cbc);

$cac_signature = $xml->createElement('cac:Signature');
$cac_signature = $Invoice->appendChild($cac_signature);

$cbc = $xml->createElement('cbc:ID', $factura[0]->RUC_EMP);
...
$cbc = $xml->createElement('cbc:Name', $factura[0]->Nom_Emp);
$cbc = $cac->appendChild($cbc);
...
$cbc = $xml->createElement('cbc:ID', $factura[0]->Num_Doc_CP);
$cbc = $cac->appendChild($cbc);

$cac = $xml->createElement('cac:PartyName');
$cac = $agent->appendChild($cac);

$cbc = $xml->createElement('cbc:Name', $factura[0]->NOM_CP);
$cbc = $cac->appendChild($cbc);

$cac = $xml->createElement('cac:PartyLegalEntity');
$cac = $agent->appendChild($cac);

$cbc = $xml->createElement('cbc:RegistrationName', $factura[0]->NOM_CP);
$cbc = $cac->appendChild($cbc);
...
$cbc = $xml->createElement('cbc:CustomerAssignedAccountID', $factura[0]->RUC_EMP);
...
$cbc = $xml->createElement('cbc:StreetName', $factura[0]->Dir_CP);
$cbc = $address->appendChild($cbc);
...
$cbc = $xml->createElement('cbc:TaxAmount', $factura[0]->Tas_Imp);
...
$cbc = $xml->createElement('cbc:TaxableAmount', '0.00');
$cbc = $taxtsubtotal->appendChild($cbc);
$cbc->setAttribute('currencyID', "PEN");
...
$nombre = $factura[0]->RUC_EMP.'-'.$factura[0]->Cod_Doc.'-'.$factura[0]->Ser_Doc.'-'.$factura[0]->Num_Doc;
