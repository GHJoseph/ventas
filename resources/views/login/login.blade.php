            ...
            <div class="col-xl-3 col-lg-4 col-md-12 col-sm-12 p-r-0">
                <div class="card position">
                    ...
                    <form class="col-md-12" id="sign_in">
                        ...
                        <div id="error" class="alert alert-danger" style="display: none; font-size: 10px; padding-top: 1px; padding-bottom: 1px;">
                            <strong>Error!</strong>
                            <p id="mensaje" style="padding: 0px;"></p>
                        </div>
        ...
        $(document).on('click', '.btn_ingresar', function () {
            ...
            $.ajax({
                ...
                if (data.estado == 1) {
                    ...
                    $('#error').show();
                    $('#mensaje').html('Credenciales de acceso incorrectos');
                }
            }).fail(function () {
