  ...
  $selectVD="SELECT * FROM ventas_resumen where Num_Nota='$NumNota'";
$resultVD = mysqli_query($conexion, $selectVD);
  $selectV="SELECT * FROM ventas_notas where Num_Nota='$NumNota'";
...
$resultR = mysqli_query($conexion, $selectR);
 ...
 <section class="invoice">
    ...
    <div class="row">
      ...
      <div class="col-xs-7">
        <p class="text-muted well well-sm no-shadow" style="margin-top: 10px;"> Representación Impresa de la <?php  echo $nombre; ?> DE VENTA ELECTRÓNICA, consultar documentos visitando la gágina www.facttron.com/20123964579 Autorizado mediante Resolución de Superintendencia N°155-2017/Sunat. </p>
      </div>
      <!-- /.col -->
